...
public class Product {
    ...
    /**
    * Returns the price of a product, applying a discount if the user has a fidelity card.
    * <p>
    * If the user has a fidelity card, a 2% discount is applied to the price including VAT.
    * Otherwise, the full price including VAT is returned.
    * </p>
    * Generated by AI
    *
    * @param hasFidelityCard a boolean indicating whether the user has a fidelity card
    * @return the price of the product, with a 2% discount if the user has a fidelity card, otherwise the full price
    */
